...
export function Cards({ title, tags = [], bgColor = "#f3c6d0", saved: initialSaved = false }) {
  const [saved, setSaved] = useState(initialSaved);

  return (
    <div className="bg-[#1e1e1e] rounded-2xl overflow-hidden flex flex-col">
      <div
        className="w-full h-44 flex items-center justify-center text-sm text-white/40 font-light tracking-widest"
